<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Transaction Detail ({{ $transaction->name }})
        </h2>
    </x-slot>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <table class="table-auto w-full">
                        <tbody>
                            ...
                            <tr>
                                <th class="border px-6 py-4 text-right">Created At</th>
                                <td class="border px-6 py-4">{{ date('j F Y', strtotime($transaction->created_at)) }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
